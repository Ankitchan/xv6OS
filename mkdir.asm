...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	0f b6 80 50 0b 00 00 	movzbl 0xb50(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5c9:	75 25                	jne    5f0 <printf+0x12e>
          s = "(null)";
 5cb:	c7 45 f4 da 08 00 00 	movl   $0x8da,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 75c:	a3 6c 0b 00 00       	mov    %eax,0xb6c
}
 761:	90                   	nop
 762:	c9                   	leave  
 763:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7ba:	83 c4 10             	add    $0x10,%esp
  return freep;
 7bd:	a1 6c 0b 00 00       	mov    0xb6c,%eax
}
 7c2:	c9                   	leave  
 7c3:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7d6:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7d9:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 7de:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7e1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7e5:	75 23                	jne    80a <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7e7:	c7 45 f0 64 0b 00 00 	movl   $0xb64,-0x10(%ebp)
 7ee:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7f1:	a3 6c 0b 00 00       	mov    %eax,0xb6c
 7f6:	a1 6c 0b 00 00       	mov    0xb6c,%eax
 7fb:	a3 64 0b 00 00       	mov    %eax,0xb64
    base.s.size = 0;
 800:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 807:	00 00 00 
  }
 ...
 85d:	a3 6c 0b 00 00       	mov    %eax,0xb6c
      return (void*)(p + 1);
 ...
 868:	eb 3b                	jmp    8a5 <malloc+0xe1>
    ...
    if(p == freep)
 86a:	a1 6c 0b 00 00       	mov    0xb6c,%eax
