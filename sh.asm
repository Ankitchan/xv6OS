...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 c4 14 00 00 	mov    0x14c4(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	83 ec 0c             	sub    $0xc,%esp
      27:	68 98 14 00 00       	push   $0x1498
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      6b:	50                   	push   %eax
      6c:	68 9f 14 00 00       	push   $0x149f
      71:	6a 02                	push   $0x2
      73:	e8 38 10 00 00       	call   10b0 <printf>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      be:	50                   	push   %eax
      bf:	68 af 14 00 00       	push   $0x14af
      c4:	6a 02                	push   $0x2
      c6:	e8 e5 0f 00 00       	call   10b0 <printf>
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     143:	68 bf 14 00 00       	push   $0x14bf
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     254:	68 dc 14 00 00       	push   $0x14dc
     259:	6a 02                	push   $0x2
     25b:	e8 50 0e 00 00       	call   10b0 <printf>
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     2cc:	6a 02                	push   $0x2
     2ce:	68 df 14 00 00       	push   $0x14df
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     341:	50                   	push   %eax
     342:	68 e7 14 00 00       	push   $0x14e7
     347:	6a 02                	push   $0x2
     349:	e8 62 0d 00 00       	call   10b0 <printf>
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     3a8:	68 f5 14 00 00       	push   $0x14f5
     3ad:	6a 02                	push   $0x2
     3af:	e8 fc 0c 00 00       	call   10b0 <printf>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     3d3:	68 f9 14 00 00       	push   $0x14f9
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 bd 0f 00 00       	call   13b2 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 87 0f 00 00       	call   13b2 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 24 0f 00 00       	call   13b2 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 dc 0e 00 00       	call   13b2 <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 94 0e 00 00       	call   13b2 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 34 1a 00 00       	push   $0x1a34
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 34 1a 00 00       	push   $0x1a34
     ...
     63c:	50                   	push   %eax
     63d:	68 3c 1a 00 00       	push   $0x1a3c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 34 1a 00 00       	push   $0x1a34
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 34 1a 00 00       	push   $0x1a34
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 fe 14 00 00       	push   $0x14fe
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 ff 14 00 00       	push   $0x14ff
     772:	6a 02                	push   $0x2
     774:	e8 37 09 00 00       	call   10b0 <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 0e 15 00 00       	push   $0x150e
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 15 15 00 00       	push   $0x1515
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 17 15 00 00       	push   $0x1517
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 19 15 00 00       	push   $0x1519
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 1b 15 00 00       	push   $0x151b
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 38 15 00 00       	push   $0x1538
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 3b 15 00 00       	push   $0x153b
    ...
    panic("parseblock");
     ...
     9c4:	68 3d 15 00 00       	push   $0x153d
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 48 15 00 00       	push   $0x1548
    ...
    panic("syntax - missing )");
     ...
     a14:	68 4a 15 00 00       	push   $0x154a
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 3b 15 00 00       	push   $0x153b
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 0e 15 00 00       	push   $0x150e
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 5d 15 00 00       	push   $0x155d
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 6b 15 00 00       	push   $0x156b
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 70 15 00 00 	mov    0x1570(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ff8:	0f b6 80 44 1a 00 00 	movzbl 0x1a44(%eax),%eax
...
printlong(int fd, unsigned long long xx, int base, int sgn)
{
    ...
    106b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    // Force hexadecimal
    uint upper, lower;
    upper = xx >> 32;
    106e:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1071:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    1074:	89 d0                	mov    %edx,%eax
    1076:	31 d2                	xor    %edx,%edx
    1078:	89 45 f4             	mov    %eax,-0xc(%ebp)
    lower = xx & 0xffffffff;
    107b:	8b 45 e0             	mov    -0x20(%ebp),%eax
    107e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(upper) printint(fd, upper, 16, 0);
    1081:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1085:	74 13                	je     109a <printlong+0x3e>
    1087:	8b 45 f4             	mov    -0xc(%ebp),%eax
    108a:	6a 00                	push   $0x0
    108c:	6a 10                	push   $0x10
    108e:	50                   	push   %eax
    108f:	ff 75 08             	pushl  0x8(%ebp)
    1092:	e8 11 ff ff ff       	call   fa8 <printint>
    ...
    10a5:	e8 fe fe ff ff       	call   fa8 <printint>
...
printf(int fd, char *fmt, ...)
{
    ...
    10b3:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    10b6:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    10bd:	8d 45 0c             	lea    0xc(%ebp),%eax
    10c0:	83 c0 04             	add    $0x4,%eax
    10c3:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    10c6:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    10cd:	e9 88 01 00 00       	jmp    125a <printf+0x1aa>
    c = fmt[i] & 0xff;
    ...
    10e0:	25 ff 00 00 00       	and    $0xff,%eax
    10e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    10e8:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    10ec:	75 2c                	jne    111a <printf+0x6a>
      if(c == '%'){
    10ee:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    10f2:	75 0c                	jne    1100 <printf+0x50>
        state = '%';
    10f4:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    10fb:	e9 56 01 00 00       	jmp    1256 <printf+0x1a6>
      } else {
        putc(fd, c);
    ...
    110d:	e8 73 fe ff ff       	call   f85 <putc>
    1112:	83 c4 10             	add    $0x10,%esp
    1115:	e9 3c 01 00 00       	jmp    1256 <printf+0x1a6>
      }
    } else if(state == '%'){
    111a:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    111e:	0f 85 32 01 00 00    	jne    1256 <printf+0x1a6>
      if(c == 'd'){
    1124:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    1128:	75 1e                	jne    1148 <printf+0x98>
        printint(fd, *ap, 10, 1);
    112a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    112d:	8b 00                	mov    (%eax),%eax
    112f:	6a 01                	push   $0x1
    1131:	6a 0a                	push   $0xa
    1133:	50                   	push   %eax
    1134:	ff 75 08             	pushl  0x8(%ebp)
    1137:	e8 6c fe ff ff       	call   fa8 <printint>
    113c:	83 c4 10             	add    $0x10,%esp
        ap++;
    113f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1143:	e9 07 01 00 00       	jmp    124f <printf+0x19f>
      } else if(c == 'l') {
    1148:	83 7d e4 6c          	cmpl   $0x6c,-0x1c(%ebp)
    114c:	75 29                	jne    1177 <printf+0xc7>
        printlong(fd, *(unsigned long long *)ap, 10, 0);
    114e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1151:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    1162:	e8 f5 fe ff ff       	call   105c <printlong>
    1167:	83 c4 20             	add    $0x20,%esp
        // long longs take up 2 argument slots
        ap++;
    116a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        ap++;
    116e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1172:	e9 d8 00 00 00       	jmp    124f <printf+0x19f>
      } else if(c == 'x' || c == 'p'){
    1177:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    117b:	74 06                	je     1183 <printf+0xd3>
    117d:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    1181:	75 1e                	jne    11a1 <printf+0xf1>
        printint(fd, *ap, 16, 0);
    1183:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1186:	8b 00                	mov    (%eax),%eax
    1188:	6a 00                	push   $0x0
    118a:	6a 10                	push   $0x10
    118c:	50                   	push   %eax
    118d:	ff 75 08             	pushl  0x8(%ebp)
    1190:	e8 13 fe ff ff       	call   fa8 <printint>
    1195:	83 c4 10             	add    $0x10,%esp
        ap++;
    1198:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    119c:	e9 ae 00 00 00       	jmp    124f <printf+0x19f>
      } else if(c == 's'){
    11a1:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    11a5:	75 43                	jne    11ea <printf+0x13a>
        s = (char*)*ap;
    ...
    11b7:	75 25                	jne    11de <printf+0x12e>
          s = "(null)";
    11b9:	c7 45 f4 88 15 00 00 	movl   $0x1588,-0xc(%ebp)
        while(*s != 0){
    11c0:	eb 1c                	jmp    11de <printf+0x12e>
          putc(fd, *s);
    11c2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11c5:	0f b6 00             	movzbl (%eax),%eax
    11c8:	0f be c0             	movsbl %al,%eax
    11cb:	83 ec 08             	sub    $0x8,%esp
    11ce:	50                   	push   %eax
    11cf:	ff 75 08             	pushl  0x8(%ebp)
    11d2:	e8 ae fd ff ff       	call   f85 <putc>
    11d7:	83 c4 10             	add    $0x10,%esp
          s++;
    11da:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
        while(*s != 0){
    11de:	8b 45 f4             	mov    -0xc(%ebp),%eax
    11e1:	0f b6 00             	movzbl (%eax),%eax
    11e4:	84 c0                	test   %al,%al
    11e6:	75 da                	jne    11c2 <printf+0x112>
    11e8:	eb 65                	jmp    124f <printf+0x19f>
        }
      } else if(c == 'c'){
    11ea:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    11ee:	75 1d                	jne    120d <printf+0x15d>
        putc(fd, *ap);
    ...
    11ff:	e8 81 fd ff ff       	call   f85 <putc>
    1204:	83 c4 10             	add    $0x10,%esp
        ap++;
    1207:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    120b:	eb 42                	jmp    124f <printf+0x19f>
      } else if(c == '%'){
    120d:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    1211:	75 17                	jne    122a <printf+0x17a>
        putc(fd, c);
    ...
    1220:	e8 60 fd ff ff       	call   f85 <putc>
    1225:	83 c4 10             	add    $0x10,%esp
    1228:	eb 25                	jmp    124f <printf+0x19f>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    122a:	83 ec 08             	sub    $0x8,%esp
    122d:	6a 25                	push   $0x25
    122f:	ff 75 08             	pushl  0x8(%ebp)
    1232:	e8 4e fd ff ff       	call   f85 <putc>
    ...
    1247:	e8 39 fd ff ff       	call   f85 <putc>
    124c:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    124f:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    1256:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    ...
    1267:	0f 85 65 fe ff ff    	jne    10d2 <printf+0x22>
    }
  }
}
    126d:	90                   	nop
...
free(void *ap)
{
  ...
  freep = p;
    ...
    134a:	a3 cc 1a 00 00       	mov    %eax,0x1acc
}
    134f:	90                   	nop
    1350:	c9                   	leave  
    1351:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    1355:	83 ec 18             	sub    $0x18,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    1358:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    135f:	77 07                	ja     1368 <morecore+0x16>
    nu = 4096;
    1361:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    1368:	8b 45 08             	mov    0x8(%ebp),%eax
    136b:	c1 e0 03             	shl    $0x3,%eax
    136e:	83 ec 0c             	sub    $0xc,%esp
    1371:	50                   	push   %eax
    1372:	e8 e6 fb ff ff       	call   f5d <sbrk>
    1377:	83 c4 10             	add    $0x10,%esp
    137a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    137d:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    1381:	75 07                	jne    138a <morecore+0x38>
    return 0;
    1383:	b8 00 00 00 00       	mov    $0x0,%eax
    1388:	eb 26                	jmp    13b0 <morecore+0x5e>
  hp = (Header*)p;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    13d3:	75 23                	jne    13f8 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    13d5:	c7 45 f0 c4 1a 00 00 	movl   $0x1ac4,-0x10(%ebp)
    13dc:	8b 45 f0             	mov    -0x10(%ebp),%eax
    13df:	a3 cc 1a 00 00       	mov    %eax,0x1acc
    13e4:	a1 cc 1a 00 00       	mov    0x1acc,%eax
    13e9:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
    base.s.size = 0;
    13ee:	c7 05 c8 1a 00 00 00 	movl   $0x0,0x1ac8
    13f5:	00 00 00 
  }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
    148e:	e9 6d ff ff ff       	jmp    1400 <malloc+0x4e>
  }
}
    1493:	c9                   	leave  
    1494:	c3                   	ret    
